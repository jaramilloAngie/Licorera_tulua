...
const HorizontalCardProduct = ({category, heading}) => {
  ...
  return (
           ...
           {   loading ? (
            ...
            data.map((product,index)=>{
                return(
                    ...
                    <Link to={"product/"+product?._id} className='w-full min-w-[280px] md:min-w-[320px] max-w-[280px] md:max-w-[320px] h-36 bg-white rounded-2xl shadow flex border-2 border-green-600'>
                        <div className='bg-green-200 h-full p-4 min-w-[120px] md:min-w-[145px] border-1 border-green-600 rounded-2xl' >
    ...
    <button className='text-sm bg-green-600 hover:bg-green-700 text-white px-3 py-0.5 rounded-full' onClick={(e)=>handleAddToCart(e, product?._id)}>Añadir al carrito</button>
</div>
