                ...
                {loading ? (
                    ...
                    <>
                        ...
                        {data.map((product, index) => (
                            <Link key={index} to={`product/${product?._id}`} className='w-full min-w-[280px] md:min-w-[320px] max-w-[280px] md:max-w-[320px] bg-white shadow rounded-md border-2 border-green-600'>
