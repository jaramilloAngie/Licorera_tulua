    ...
    <div className='grid grid-cols-[repeat(auto-fit,minmax(260px,300px))] justify-center md:gap-4 overflow-x-scroll scrollbar-none transition-all'>
    {
         ...
         loading ? (
             ...
             data.map((product,index)=>{
                 return(
                     <Link to={"/product/"+product?._id} className='w-full min-w-[280px]  md:min-w-[300px] max-w-[280px] md:max-w-[300px]  bg-white shadow rounded-md border-2 border-green-600' onClick={scrollTop}>
